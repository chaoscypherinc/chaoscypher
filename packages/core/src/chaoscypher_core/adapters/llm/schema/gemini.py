...
"""Gemini schema builder for LLM function calling.

Builds Google Gemini-compatible tool schemas for structured data extraction.
"""

from typing import Any


class GeminiSchemaBuilder:
    """Build Google Gemini format schemas.
    ...
    def build(tool_name: str, json_schema: dict[str, Any]) -> list[dict[str, Any]]:
        """Build Google Gemini format schema.
