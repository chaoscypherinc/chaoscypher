# ChaosCypher Individual Contributor License Agreement
...
This CLA is based on the Apache Software Foundation Individual CLA.
...
1. **Definitions.** "Contribution" means any original work of authorship,
   ...
   intentionally submitted by you to the Project for inclusion in the
   Project. "Submitted" means any form of communication sent to the
   Project, including pull requests, issues, and comments.

2. **Grant of Copyright License.** You hereby grant to Us and to
...
3. **Grant of Patent License.** You hereby grant to Us and to recipients
   ...
   combination of your Contribution(s) with the Project.

4. **Representations.** You represent that you are legally entitled to
   ...
   employer has waived such rights, or that your employer has signed a
   separate Corporate CLA with Us.

5. **Original Work.** You represent that each of your Contributions is
   your original creation. You represent that your Contribution
   submissions include complete details of any third-party license or
   other restriction of which you are aware.

6. **Support.** You are not expected to provide support for your
   Contributions, except to the extent you desire to provide support.

7. **No Warranty.** Your Contributions are provided "AS IS", WITHOUT
